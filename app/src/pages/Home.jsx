...
import NotFoundPopup from '../components/NotFoundPopup/NotFoundPopup';
...
function Home() {
    ...
    // run a search when the navbar sets a query
    useEffect(() => {
